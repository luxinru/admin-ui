<template>
    <el-dialog :title="title" v-model="open" width="93vw" top="5vh" append-to-body :close-on-click-modal='false' >
        <el-card v-show="materialObjectOpen">
            实物信息
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="资产分类名称" prop="contentAssetsName">
                            <el-input v-model="materialObjectForm.contentAssetsName" placeholder="请输入" maxlength="25" disabled/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="资产类型" prop="assetsType">
                            <el-select v-model="materialObjectForm.assetsType" placeholder="综合编码字典">
                                <el-option v-for="dict in tempOptions" :key="dict.tempCode" :label="dict.tempName" :value="dict.tempCode"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="所属单位" prop="departName">
                            <el-select v-model="materialObjectForm.departName" placeholder="所属单位共用弹窗" @change="departLinkageDutyFmisCostCenter()">
                                <el-option v-for="dict in tempOptions" :key="dict.tempCode" :label="dict.tempName" :value="dict.tempCode" ></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="增加日期" prop="addVoucherDate">
                            <el-input v-model="materialObjectForm.addVoucherDate" placeholder="自动生成" maxlength="50" disabled/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="基层鉴定部门" prop="basicJudgeDepartName">
                            <el-input v-model="materialObjectForm.basicJudgeDepartName" placeholder="保存后自动生成" maxlength="50" disabled/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="地区公司鉴定部门" prop="regionJudgeDepartName">
                            <el-input v-model="materialObjectForm.regionJudgeDepartName" placeholder="保存后自动生成" maxlength="50" disabled/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="参考原值" prop="referenceOriginalValue">
                            <el-input v-model="materialObjectForm.referenceOriginalValue" placeholder="请输入参考原值" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="成本监审分类编码" prop="costCategory">
                            <el-input v-model="materialObjectForm.costCategory" placeholder="请输入成本监审分类编码" maxlength="25" disabled/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="成本监审分类名称" prop="costCategoryName">
                            <el-input v-model="materialObjectForm.costCategoryName" placeholder="请输入成本监审分类名称" maxlength="50" disabled/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="18">
        ...
        <el-card v-show="normOpen">
            会计准则
            <el-form ref="normOpenAccountantFormRef" :model="normOpenAccountantForm" :rules="normOpen?normOpenAccountantFormRules:null" label-width="130px">
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="原值" prop="originalValue">
                            <el-input v-model="normOpenAccountantForm.originalValue" placeholder="请输入原值" maxlength="50" @blur="accountantOriginalValueLinkageOtherNorm()"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
            ...
            <el-form ref="normOpenTaxFormRef" :model="normOpenTaxForm" :rules="normOpen?normOpenTaxFormRules:null" label-width="130px">
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="原值" prop="originalValue">
                            <el-input v-model="normOpenTaxForm.originalValue" placeholder="请输入原值" maxlength="50" @blur="taxOriginalValueLinkageNowValue()"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="净值" prop="nowValue">
            ...
            <el-form ref="normOpenAssessmentFormRef" :model="normOpenAssessmentForm" :rules="normOpen?normOpenAssessmentFormRules:null" label-width="130px">
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="原值" prop="originalValue">
                            <el-input v-model="normOpenAssessmentForm.originalValue" placeholder="请输入原值" maxlength="50" @blur="assessmentOriginalValueLinkageNowValue()"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="净值" prop="nowValue">
            ...
            成本监审准则
            <el-form ref="normOpenSupervisionFormRef" :model="normOpenSupervisionForm" :rules="normOpen?normOpenSupervisionFormRules:null" label-width="130px">
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="原值" prop="originalValue">
                            <el-input v-model="normOpenSupervisionForm.originalValue" placeholder="请输入原值" maxlength="50" @blur="supervisionOriginalValueLinkageNowValue()"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="净值" prop="nowValue">
        ...
        <el-card v-show="houseOpen">
            房屋信息
            <el-form ref="houseOpenFormRef" :model="houseOpenForm" :rules="houseOpen?houseOpenFormRules:null" label-width="170px">
<!--            <el-form ref="houseOpenFormRef" :model="houseOpenForm" :rules="houseOpen?null:null" label-width="170px">-->
                <el-row>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="权属状况" prop="ownershipConditionName">
                            <el-input v-model="houseOpenForm.ownershipConditionName" readonly @click="openComplexCodeCard('ownershipCondition', '权属状况')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="使用权类型" prop="usedrightTypeName">
                            <el-input v-model="houseOpenForm.usedrightTypeName" readonly @click="openComplexCodeCard('usedrightType', '使用权类型')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="权利类型" prop="rightTypeName">
                            <el-input v-model="houseOpenForm.rightTypeName" readonly @click="openComplexCodeCard('rightType', '权利类型')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="权利性质" prop="rightNatureName">
                            <el-input v-model="houseOpenForm.rightNatureName" readonly @click="openComplexCodeCard('rightNature', '权利性质')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="办证情况" prop="certificateHandlingName">
                            <el-input v-model="houseOpenForm.certificateHandlingName" readonly @click="openComplexCodeCard('certificateHandling', '办证情况')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="无证原因" prop="noCertificateReason">
                            <el-input v-model="houseOpenForm.noCertificateReason" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="实物资产形成原因" prop="formReasonName">
                            <el-input v-model="houseOpenForm.formReasonName" readonly @click="openComplexCodeCard('formReason', '实物资产形成原因')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="实物资产补充说明" prop="realMoreInfo">
                            <el-input v-model="houseOpenForm.realMoreInfo" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="建筑物地上总层数" prop="floorsUpName">
                            <el-input v-model="houseOpenForm.floorsUpName" readonly @click="openComplexCodeCard('floorsUp', '建筑物地上总层数')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="建筑物地下总层数" prop="floorsDownName">
                            <el-input v-model="houseOpenForm.floorsDownName" readonly @click="openComplexCodeCard('floorsDown', '建筑物地下总层数')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="建筑信息备注" prop="buildInfoRemark">
                            <el-input v-model="houseOpenForm.buildInfoRemark" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="使用性质" prop="usedNatureName">
                            <el-input v-model="houseOpenForm.usedNatureName" readonly @click="openComplexCodeCard('usedNature', '使用性质')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="房屋结构" prop="houseStructureName">
                            <el-input v-model="houseOpenForm.houseStructureName" readonly @click="openComplexCodeCard('houseStructure', '房屋结构')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item label="停车场用途" prop="parkingUsedName">
                            <el-input v-model="houseOpenForm.parkingUsedName" readonly @click="openComplexCodeCard('parkingUsed', '停车场用途')" placeholder="请选择" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="证照与权属不一说明" prop="itemLicenceOwnershipDiff">
                            <el-input v-model="houseOpenForm.itemLicenceOwnershipDiff" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="房产与地产权属不一说明" prop="itemHouseLandDiff">
                            <el-input v-model="houseOpenForm.itemHouseLandDiff" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="安全/环保/管理隐患说明" prop="itemHideenDanger">
                            <el-input v-model="houseOpenForm.itemHideenDanger" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="无偿占用或使用说明" prop="itemFreeUsed">
                            <el-input v-model="houseOpenForm.itemFreeUsed" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="产权纠纷说明" prop="itemPropertyDispute">
                            <el-input v-model="houseOpenForm.itemPropertyDispute" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="账实不符说明" prop="itemAccountRealDiff">
                            <el-input v-model="houseOpenForm.itemAccountRealDiff" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="档案资料缺失说明" prop="itemFilesMissing">
                            <el-input v-model="houseOpenForm.itemFilesMissing" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="资产闲置说明" prop="itemAssetsUseless">
                            <el-input v-model="houseOpenForm.itemAssetsUseless" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="部分拆除或置换说明" prop="itemDisplace">
                            <el-input v-model="houseOpenForm.itemDisplace" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="已出售未下账说明" prop="itemSoldNoRecorded">
                            <el-input v-model="houseOpenForm.itemSoldNoRecorded" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="涉诉事项说明" prop="itemLawsuit">
                            <el-input v-model="houseOpenForm.itemLawsuit" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="其他问题说明" prop="itemProblem">
                            <el-input v-model="houseOpenForm.itemProblem" placeholder="请输入" maxlength="50"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-show="againShow">
                    <el-col :span="12">
        ...
        <template #footer>
            <div class="dialog-footer">
                <el-button type="primary" @click="nextStep" v-show="againShow">下一步</el-button>
...
// 声明表单属性
const {materialObjectForm, materialObjectFormRules, accountsOpenForm, accountsOpenFormRules,
    ...
    houseOpenForm, houseOpenFormRules}  = toRefs(data);
