    ...
    <el-row>
      ...
      <el-dialog :title="title" v-model="open" width="600px" append-to-body>
        <el-form :model="form" ref="formRef" label-width="80px">
          ...
          <el-form-item label="单据类型"> 变更-实物资产 </el-form-item>
...
<script setup>
import { sendInvoice, listAdjust, getAdjust, delAdjust, addAdjust, updateAdjust } from "@/api/assets/real/adjust/invoice";
...
function getList() {
  ...
  listAdjust(proxy.addDateRange(queryParams.value)).then(res => {
    loading.value = false;
...
function handleExport() {
  proxy.download("business/adjust/invoice/export", {
    ...queryParams.value
