  ...
  <div class="app-container">
    ...
    <el-row>
      <el-table v-loading="loading" :data="invoiceList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="所属单位" key="departName" align="center" prop="departName" width="110" :show-overflow-tooltip="true"/>
...
<script setup>
import { listAdjust, handleBack } from "@/api/assets/real/adjust/invoice";
