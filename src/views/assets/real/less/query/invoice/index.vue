<template>
  <div class="app-container">
    ...
    <el-row>
      <el-table v-loading="loading" :data="invoiceList" @selection-change="handleSelectionChange" :height="height">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column label="单据编号" align="center" width="200">
          <template #default="scope">
            <router-link :to="{
                        path:'/less/query/detail',
                        query:{
...
<script setup>
import { listInvoice, handleBack } from "@/api/assets/real/less/invoice";
