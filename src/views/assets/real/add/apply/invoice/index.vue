...
<script setup>
import { listInvoice, addInvoice, updateInvoice, getInvoice, delInvoice, sendInvoice } from "@/api/assets/real/add/invoice";
...
function importTemplate() {
  ...
  proxy.download("business/add/invoice/importTemplate", {}, `add_invoice_template_${new Date().getTime()}.xlsx`);
};
/**文件上传中处理 */
