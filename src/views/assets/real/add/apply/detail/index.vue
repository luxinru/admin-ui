<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['assets:add:apply:detail:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
...
<script setup>
import {listDetail,addDetail,getDetail,updateDetail,delDetail} from "@/api/assets/real/add/detail";
...
/** 新增按钮操作 */
function handleAdd() {
  card.value.add(queryParams.value.invoiceNumber,"资产新增");
}
/** 查看按钮操作 */
function handleView() {
  const id = ids
...
function handleExport() {
  proxy.download("business/add/detail/export", {
    ...queryParams.value,
