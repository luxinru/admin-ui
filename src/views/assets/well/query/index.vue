    ...
    <div class="app-container">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
        ...
        <el-form-item label="井别名称" prop="wellTypeName">
          <el-input v-model="queryParams.wellTypeName" @keyup.enter="handleQuery" style="width: 140px" clearable placeholder="请输入井别名称" @click="openComplexCodeCard('welltypecode')"/>
        </el-form-item>
        <el-form-item>
