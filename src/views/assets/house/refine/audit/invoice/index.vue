          ...
          <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange" :height="height">
            ...
            <el-table-column label="单据编号" align="center" prop="invoiceNumber" width="220" :show-overflow-tooltip="true">
              <template #default="scope">
                <router-link :to="{ path:'/refine/audit/detailsend',
                              query:{
...
<script setup>
import { listHouseRefineInvoice, approvalInvoiceAgree, approvalInvoiceUnAgree } from "@/api/assets/house/refine/invoice";
import auditPage from "@/views/assets/house/refine/components/audit/index";
...
const data = reactive({
  ...
  queryParams: {
    ...
    invoiceStatus: null,
    dataFilter: Base64.encode(" and invoice_status in ('03')")
  },
  rules: {
