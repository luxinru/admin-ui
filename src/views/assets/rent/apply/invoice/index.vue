  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Check"  :disabled="multiple"
                   @click="handleReportTo">上报</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-row>
      <el-table v-loading="loading" :data="invoiceList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="备注" key="remark" align="center" prop="remark" width="220" />
      </el-table>
      ...
      <el-dialog :title="title" v-model="open" width="600px" append-to-body>
        <el-form :model="form" ref="formRef" label-width="80px">
          <el-form-item label="单据类型"> 出租-资产 </el-form-item>
...
<script setup>
import { listInvoice, addInvoice, updateInvoice, getInvoice, delInvoice, reportTo } from "@/api/assets/rent/apply/invoice";
...
const invoiceStatusOptions = ref([
  ...
  {codeProperty1: '03', codeName1: '信息维护'},
  {codeProperty1: '04', codeName1: '审批中'},
  {codeProperty1: '05', codeName1: '审批完成'},
]);
// 单据类型
...
function handleExport() {
  proxy.download("rent/apply/invoice/export", {
    ...queryParams.value
...
function importTemplate() {
  proxy.download("business/add/invoice/importTemplate", {
  }, `add_invoice_template_${new Date().getTime()}.xlsx`);
};
/**文件上传中处理 */
