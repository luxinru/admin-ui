...
<script setup>
import { listInvoice, sendInvoice } from "@/api/assets/rent/edit/invoice";
...
queryParams.value.dataFilter = Base64.encode(" and invoice_status in ('02','03')");
// 表单参数
const form=ref({});
getList();
