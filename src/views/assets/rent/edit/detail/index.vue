...
<!--      <el-col :span="1.5">-->
<!--        <el-button type="primary" plain icon="Folder"  @click="handleSave">保存</el-button>-->
<!--      </el-col>-->
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus"  @click="handleAdd"  >增加</el-button>
      </el-col>
      <el-col :span="1.5">
...
/** 新增按钮操作 */
function handleAdd() {
  card.value.add(queryContractParams.value.assetsCode,"资产新增");
}
