   ...
   <div class="app-container">
      <el-row :gutter="20">
         ...
         <el-col :span="4" :xs="24">
            ...
            <div class="head-container">
               <div class="tree">
                  <el-tree-v2 ref="treeRef" :data="deptOptions" :props=props :filter-method="filterMethod" :height="800"
              ...
              <!-- todo
               <el-col :span="12">
                  <el-form-item label="归属部门" prop="departCode">
                     <treeselect v-model="form.departCode" :options="deptOptions" :multiple="true"  :normalizer="normalizer"
                        placeholder="请选择归属部门" />
                  </el-form-item>
               </el-col>
              -->
