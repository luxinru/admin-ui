      ...
      <el-row :gutter="20">
         ...
         <el-col :span="4" :xs="24">
            <div class="head-container">
               ...
               <el-input v-model="query" placeholder="请输入部门名称" @input="onQueryChanged" clearable prefix-icon="Search"
                  style="margin-bottom: 20px" />
            </div>
            <div class="head-container">
               <div class="tree">
                  <el-tree-v2 ref="treeRef" :data="assetOptions" :props=props :filter-method="filterMethod"
                     :height="800" :default-expand-all="defaultExpand" v-if="treeOpen" v-loading="treeLoading"
            ...
            <!-- <el-row>
                ...
                <el-col :span="12">
                   <el-form-item label="归属部门" prop="deptId">
                      <el-tree-select v-model="form.deptId" :data="deptOptions" :props=props value-key="departCode"
                         :multiple="true" placeholder="请选择归属部门" check-strictly />
                   </el-form-item>
                </el-col>
            ...
            <el-row>
               ...
               <!-- <el-col :span="12">
                   <el-form-item label="归属部门" prop="departCode">
                      <treeselect v-model="form.departCode" :options="deptOptions" :multiple="true" :show-count="true"
                         placeholder="请选择归属部门" />
                   </el-form-item>
                </el-col> -->
            </el-row>
...
import { listUser, resetUserPwd, delUser, getUser, updateUser, addUser, deptTreeSelect } from "@/api/system/user";
...
const filterMethod = (query, node) => {
   ...
   return node.departName.indexOf(query) !== -1;
}
...
function handleNodeClick(data) {
   queryParams.value.departCode = data.departCode;
   handleQuery();
};
/** 搜索按钮操作 */
